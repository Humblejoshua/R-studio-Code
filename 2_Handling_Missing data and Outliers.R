...
Happiness = read_xlsx("Happiness_Score.xlsx")
...
#View the result
names(Happiness)#tosee namesof variables in data set


##CENTRAL TENDENCY OF Data ----
summary(Happiness)
#to give us the statistics of our data set,,... we can visually mathematically tell if the data has outliers
...
###Method 2##This is the more preferred method
missing_values <- sapply(Happiness , function (x) (sum(is.na(x))))
missing_values
...
########EXAMPLE 2 ON HANDLING MISSING DATA----

####IMPORTING A CSV FILE##----
#Let's use a different dataset "Female_Mps.csv)
setwd("/Users/keksmacbookair/Desktop/course work/Intro to Data science/data sets")

Data2 = read_csv("Female_Mps.csv")
View(Data2)
...
#or
library(dplyr)
missing_values_2 <-Data2 %>% summarise_all(funs(sum(is.na(.))))
missing_values_2
sum(missing_values_2)# gives the same observations
...
hist(Sample_data$Price, main = "Distribution of Price")
#Q-Q plot
qqnorm(Sample_data$Price, main = "Distribution of Price")
